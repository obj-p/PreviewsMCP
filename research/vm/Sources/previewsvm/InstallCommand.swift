...
/// Setup Assistant yet — `previewsvm boot` works, but you'd see Setup
...
struct InstallCommand: AsyncParsableCommand {
    ...
    @Option(
        ...
        help: ArgumentHelp(
            ...
            discussion: "Downloaded IPSWs are cached at ~/.cache/previewsvm/ipsw/."
        )
    )
    var ipsw: String?
    ...
    private func printNextStepBanner(bundle: VMBundle, ipswURL: URL) {
        ...
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          ...
          Setup Assistant has not yet run. `previewsvm boot` will work,
          but the framebuffer (unattached) will be sitting at Setup
          Assistant, and SSH is not yet enabled — so `previewsvm ssh`
