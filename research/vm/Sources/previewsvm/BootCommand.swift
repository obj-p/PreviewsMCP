...
/// the VZ runloop drives the VM; another shell connects via `previewsvm
...
struct BootCommand: AsyncParsableCommand {
    ...
    private func printFirstBootBanner(bundle: VMBundle) {
        ...
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          previewsvm — first-boot (hidden display) running
            \(bundle.url.path)
    ...
    private func printConnectionBanner(bundle: VMBundle, ip: String) {
        ...
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          previewsvm — VM up at \(ip)

          From another shell:
            previewsvm ssh \(bundle.url.path) -- <cmd>
            previewsvm stop \(bundle.url.path)
